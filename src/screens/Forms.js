...
const Forms = inject("MainStore")(observer(({ MainStore, navigation }) => {

  const itemsPerPage = 4; // Her sayfada gösterilecek öğe sayısı

  useEffect(() => {
    ApiConfig.getUser(navigation);
    ApiConfig.getData(PageUrl.Forms);
  }, []);
        ...
        <ScrollView horizontal style={styles.container}>
          <DataTable style={{ width: 700 }}>
            <DataTable.Header style={styles.table_title}>
              ...
              <DataTable.Title onPress={() => sortData('fields')} sortDirection={MainStore.sortedField === 'fields' ? (MainStore.sortAscending ? 'ascending' : 'descending') : 'none'}>
                Fields
              </DataTable.Title>
            </DataTable.Header>
          ...
          <View>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TouchableOpacity style={styles.button_style} onPress={() => {
                ApiConfig.deleteAlert(MainStore.selectedItems, PageUrl.Forms, PageEnum.Forms);
              }}>
